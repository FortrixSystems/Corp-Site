...
export default function Card({ children, className = '', hover = false, dark = false }: CardProps) {
  ...
  const hoverClass = hover 
    ? 'transition-all duration-200 hover:shadow-sm hover:border-fortrix-teal/40 focus-within:outline-none focus-within:ring-2 focus-within:ring-fortrix-teal focus-within:ring-offset-2' 
    : '';
  return (
