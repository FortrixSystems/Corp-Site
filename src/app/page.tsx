    ...
    <>
      ...
      <Section className="bg-fortrix-charcoal">
        ...
        <div className="mt-12 sm:mt-16">
          <div className="border border-fortrix-grey-700/30 p-6 sm:p-8 md:p-12">
            <div className="aspect-video flex items-center justify-center">
              <div className="w-full max-w-2xl">
                <div className="space-y-3">
                  <div className="h-px bg-fortrix-grey-700/40"></div>
                  <div className="h-px bg-fortrix-grey-700/30 ml-8"></div>
                  <div className="h-px bg-fortrix-grey-700/40 ml-16"></div>
                  <div className="h-px bg-fortrix-teal/50 ml-24"></div>
                  <div className="h-px bg-fortrix-grey-700/40 ml-16"></div>
                  <div className="h-px bg-fortrix-grey-700/30 ml-8"></div>
                  <div className="h-px bg-fortrix-grey-700/40"></div>
                </div>
      ...
      <Section className="bg-white" delay={100}>
      ...
      <Section className="bg-fortrix-grey-100" delay={200}>
      ...
      <Section className="bg-white" delay={300}>
