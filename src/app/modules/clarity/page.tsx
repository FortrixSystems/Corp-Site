    ...
    <>
      ...
      <Section className="bg-fortrix-navy">
        <div className="flex flex-col items-start gap-4 sm:gap-6">
          <ModuleIcon moduleId="clarity" variant="dark" size={56} className="rounded-none" />
          <PageTitle 
        ...
        <p className="text-base sm:text-lg text-fortrix-grey-300 font-regular mb-8 sm:mb-10 max-w-3xl leading-relaxed">
          Fortrix Clarity helps regulators and operators answer &quot;what happened?&quot; quickly using structured data, searchable records, and export-ready outputs. It reduces the time spent gathering artifacts, improves consistency in reviews, and supports defensible oversight across complex environments.
        </p>
      </Section>
